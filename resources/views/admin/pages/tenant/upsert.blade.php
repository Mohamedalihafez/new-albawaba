                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <select class="form-control select2 d-flex" style="height: 100px !important;" placeholder="{{ __('pages.compound_owner') }}" route="{{route('usersTenant')}}"  name="user_id">
                                                        @if($tenant->user)
                                                            <option class="form-control" selected value="{{$tenant->user->id}}">{{ $tenant->user->name }}</option>
                                                        @endif
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-2">
