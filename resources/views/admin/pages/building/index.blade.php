                ...
                <div class="page-header card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col">
                            <a href="{{ route('building.upsert') }}" class="btn btn-primary float-end ">  <i class="ti-plus"></i> {{ __('pages.add_building') }}</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form class="form" action="{{ route('building.filter') }}" method="get">
                                    ...
                                    <div id="edit_partner" class="modal fade">   
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="modelHeading">{{ __('pages.edit_building_info') }}</h4>
