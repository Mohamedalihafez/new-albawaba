            ...
            <div class="content container-fluid">
                <div class="content container-fluid">		
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title"> سياسه الخصوصيه   </h3>
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="{{ route('privacy.modify') }}" class="ajax-form" swalOnSuccess="{{ __('pages.sucessdata') }}" swalOnFail="{{ __('pages.wrongdata') }}" title="{{ __('pages.opps') }}">
                                        ...
                                        <div class="service-fields mb-3">
                                            ...
                                            <div class="col-lg-12 mb-4">
                                                ...
                                                <div>
                                                    <textarea class="form-control" type="text" id="summernote" name="policy" placeholder="">@isset($setting->id){{$setting->policy}}@endisset</textarea>
