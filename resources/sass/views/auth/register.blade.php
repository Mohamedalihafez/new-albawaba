                            ...
                            <div class="card-body">
                                <form id="register_form" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="checkbox" value="1" class="user_name">&nbsp;  <label>  الموافقه علي <a href="{{route('policy')}}"> سياسة الخصوصية      </label>
                                        <br>
                                        <input type="checkbox" value="2" class="user_name">&nbsp; <label> الموافقه علي <a href="{{route('privacy')}}"> الشروط والأحكام </a>    </label>
                                        <input hidden type="checkbox" value="3" class="user_name d-none">
                                    </div>
                                    <div class="row mb-0 mt-2">
                                        <div class="col-md-12 ">
                                            <button  disabled type="submit" class="btn btn-primary w-100 btn-bawaba">
                                             الإنضمام
                                            </button>
...
<script>
    ...
    chk1.on('change', function(){
        ...
        {
            $('.btn-bawaba').removeAttr('disabled');
        }
        else 
        {
           $('.btn-bawaba').attr('disabled', true);  
        }
