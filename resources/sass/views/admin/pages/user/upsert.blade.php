                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <input placeholder="{{ __('pages.Phone') }}" type="password" id="password" class="form-control @error('password') is-invalid @enderror" name="password" value="@isset($user->id){{$user->password}}@endisset">
                                                            <p class="error error_phone"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <label class="mb-2">صوره شخصيه</label>
                                                    <div class="form-group">
