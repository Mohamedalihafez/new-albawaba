                ...
                <div class="page-header card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col">
                            <a href="{{ route('maintenance.upsert') }}" class="btn btn-primary float-end "><i class="ti-plus"></i> {{ __('pages.add_maintenance') }}</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table id="example" class=" display  table table-hover table-center mb-0"  filter="{{ route('maintenance.filter') }}">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>{{ __('pages.name') }}</th>
                                        ...
                                        <tbody>
                                            @foreach($maintenances as $maintenance)
                                                <tr class="record">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="{{ route('maintenance.upsert',['maintenance' => $maintenance->id]) }}" class="btn btn-sm bg-success-light" >
                                                                <i class="ti-pencil"></i> {{ __('pages.edit') }}
                                                            </a>
                                                            <a  data-bs-toggle="modal" href="#" class="btn btn-sm bg-danger-light btn_delete" route="{{ route('maintenance.delete',['maintenance' => $maintenance->id])}}">
                                    ...
                                    <div id="edit_partner" class="modal fade">   
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="modelHeading">{{ __('pages.edit_maintenance_info') }}</h4>
