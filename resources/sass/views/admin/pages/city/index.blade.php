                ...
                <div class="page-header card-header">
                    <div class="row">
                        <div class="col-sm-7 col-auto">
                            <h3 class="page-title">{{ __('pages.cities') }}</h3>
                        </div>
                            ...
                            <div class="card-body   " >
                                <div class="table-responsive ">
                                    <form class="form" action="{{ route('city.filter') }}" method="get">
                                        <div class="form-group d-flex align-cities-center">
                                        ...
                                        <tbody>
                                            @foreach($cities as $city)
                                                <tr class="record">
                                                    <td>{{ $city->id }}#</td>
                                                    <td>{{ $city->name_ar }}</td>
                                                    <td>{{ $city->region->name_ar }}</td>

                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="{{ route('city.upsert',['city' => $city->id]) }}" class="btn btn-sm bg-success-light" >
                                                                <i class="ti-pencil"></i> {{ __('pages.edit') }}
                                                            </a>
                                                            <a  data-bs-toggle="modal" href="#" class="btn btn-sm bg-danger-light btn_delete" route="{{ route('city.delete',['city' => $city->id])}}">
