                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body custom-edit-service">                 
                                    <!-- Add Blog -->
                                    <form method="post" enctype="multipart/form-data" action="{{ route('features.modify') }}" class="ajax-form" swalOnSuccess="{{ __('pages.sucessdata') }}" swalOnFail="{{ __('pages.wrongdata') }}" title="{{ __('pages.opps') }}">
                                        @csrf
                                            ...
                                            <div class="col-lg-12 mb-4">
                                               ...
                                               <div class="col-lg-12 mt-3">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="file" class="dropify"  data-default-file="@isset($setting->id){{ asset('/features/'.$setting->id.'/'.$setting->gallaries->first()->name) }}@endif" name="logo"/>
